...
if(isset($_POST["action"])){
  ...
  if($_POST["action"] == "add_expense"){
    ...
    if(mysqli_query($conn, $expense_sql)){
      $output = array(
        'status'          => 'success',
        'message'         => ' La nouvelle dépense a été ajoutée avec succès.'
      );
    }
  ...
  if($_POST["action"] == "update_expense"){
    ...
    if(mysqli_query($conn, $sql)){
      $output = array(
        'status'          => 'success',
        'message'         => ' Les informations sur les dépenses ont été mises à jour avec succès.'
      );
    }
  ...
  if($_POST["action"] == "delete_expense"){
    ...
    if(mysqli_query($conn, $sql)){
      $output = array(
        'status'        => 'success',
        'message'	    	=> ' Les informations sur les dépenses ont été supprimer avec succès.',
      );
    }
