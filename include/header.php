  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">B&D MS</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="expense_category.php">
          ...
          <span> Categorie de Depenses</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="income_category.php">
          <i class="fas fa-list-ul fa-fw"></i>
          <span> Categorie de Revenue</span></a>
      </li>
      <?php endif; ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Les paiements des droits universitaires se font uniquement dans le compte N° 05021127346 clé 71 domicilié à Société Générale Cameroun (SGC).-->