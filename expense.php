...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Gérer les dépenses</h1>
      <div>
          ...
          <table class="table table-bordered table-striped" id="expenseTable" width="100%" cellspacing="0">
            <thead>
              <tr>
                ...
                <th width="10%">Mode de paiement</th>
        ...
        <div class="modal-body">
          <form id="expense_form">
            <div class="form-group">
              ...
              <input type="text" name="date" id="date" class="form-control" autocomplete="off" placeholder="Entrer la date"/>
            ...
            <div class="form-group">
              ...
              <input type="number" id="amount" name="amount" class="form-control" maxlength="100" autocomplete="off" placeholder="Entrer le montant" step="any" min="0">
              <div id="amount_error_message" class="text-danger"></div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label>Catégorie de dépenses <i class="text-danger">*</i></label>
